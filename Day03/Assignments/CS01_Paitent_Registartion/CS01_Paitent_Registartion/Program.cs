...
namespace CS01_Paitent_Registartion
{
    ...
    public class RegistrationManager
    {
        public static Patient RegisterPatient()
        {
            ...
            // Age Validation using try-catch
            while (true)
            {
                try
                {
        ...
        public static void DisplayRegistrationSlip(Patient patient)
        {
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            RegistrationManager.DisplayRegistrationSlip(patient);
