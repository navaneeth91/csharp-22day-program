...
namespace PatientRegistryConsole
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    ...
                    case "8": DisplayOldPatientsnames(); break;
                    default:
        ...
        static void DisplayMenu()
        {
            ...
            Console.WriteLine("8. Old Patients");
        ...
        static void UpdatePatient()
        {
            ...
            else
            {
                ...
                Oldpatients.Add(patients[index] + "->" + newName + " - at-" + DateTime.Now.ToString());
        ...
        static void DisplayOldPatientsnames()
        {
            Console.WriteLine($"\nOld PATIENTS ({Oldpatients.Count})");
            Console.WriteLine("---------------------------------");
