...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ClaimId).HasName("PK__Claim__EF2E139B9C7EF2F8");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BED9C9553F2");
        ...
        {
            entity.HasKey(e => e.DiagnosisId).HasName("PK__Diagnosi__0C54CC73C90B8DEB");
        ...
        {
            entity.HasKey(e => e.EncounterId).HasName("PK__Encounte__4278DD36BB5C683A");
        ...
        {
            entity.HasKey(e => e.InsuranceId).HasName("PK__Insuranc__74231A24EAD2A5E0");

            entity
                .ToTable("Insurance")
                .ToTable(tb => tb.IsTemporal(ttb =>
                    {
                        ttb.UseHistoryTable("InsuranceRecordsHistory", "dbo");
                        ttb
        ...
        {
            entity.HasKey(e => e.PatientId).HasName("PK__Patient__970EC3662B32988E");
            ...
            entity.HasIndex(e => e.Mrn, "UQ__Patient__C790FDB47CC99004").IsUnique();
        ...
        {
            entity.HasKey(e => e.ProcedureId).HasName("PK__Procedur__54C2E52DD87576D0");
        ...
        {
            entity.HasKey(e => e.ProviderId).HasName("PK__Provider__B54C687D571A1C8C");
